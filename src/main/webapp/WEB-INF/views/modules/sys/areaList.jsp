...
<body>
	...
	<table id="treeTable" class="table table-striped table-bordered table-condensed">
		<thead>
		<tr>
			<th style="text-align:center;vertical-align:middle;" >区域名称</th>
			<th style="text-align:center;vertical-align:middle;" >区域编码</th>
			<th style="text-align:center;vertical-align:middle;" >区域类型</th>

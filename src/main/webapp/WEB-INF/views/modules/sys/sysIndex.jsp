...
<div id="wrapper">
                    ...
                    <c:if test="${menu.isShow eq '1'}">
                        <li class="hidden-xs secondMenu secondMenu-${menu.parent.id}" id="secondMenu-${menu.id}">
                            ...
                            <c:if test="${not empty menu.href}">
                                <a class="J_menuItem" href="${fn:indexOf(menu.href, '://') eq -1 ? ctx : ''}${menu.href}"><i class="${menu.icon}"></i><span>${menu.name}</span></a>
                            </c:if>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right">&copy; ${fns:getConfig("copyRightYear")} <a href="http://www.whatlookingfor.com/" target="_blank">Jonathan's blog</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->

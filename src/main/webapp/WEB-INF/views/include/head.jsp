...
<meta name="author" content="http://whatlookingfor.com"/>
...
<script src="${ctxStatic}/plugins/metisMenu/jquery.metisMenu.js"></script>
...
<!-- 通知插件 -->
<link href="${ctxStatic}/plugins/toastr/toastr.min.css" rel="stylesheet">
<script src="${ctxStatic}/plugins/toastr/toastr.min.js"></script>

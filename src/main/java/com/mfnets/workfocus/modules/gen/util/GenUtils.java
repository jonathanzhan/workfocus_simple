 ...
 */
package com.mfnets.workfocus.modules.gen.util;
...
import com.mfnets.workfocus.common.mapper.JaxbMapper;
import com.mfnets.workfocus.common.utils.DateUtils;
import com.mfnets.workfocus.common.utils.FileUtils;
import com.mfnets.workfocus.common.utils.FreeMarkers;
import com.mfnets.workfocus.common.utils.StringUtils;
import com.mfnets.workfocus.modules.gen.entity.GenCategory;
import com.mfnets.workfocus.modules.gen.entity.GenConfig;
import com.mfnets.workfocus.modules.gen.entity.GenScheme;
import com.mfnets.workfocus.modules.gen.entity.GenTable;
import com.mfnets.workfocus.modules.gen.entity.GenTableColumn;
	...
	public static void initColumnField(GenTable genTable){
		for (GenTableColumn column : genTable.getColumnList()){
			...
			if (StringUtils.startsWithIgnoreCase(column.getJdbcType(), "CHAR")
				...
				else if (ss != null && ss.length == 2 && Integer.parseInt(ss[0])<=6){
					column.setJavaType("Integer");
				}
				// 长整形
				else{
				...
				// 如果是浮点型
				String[] ss = StringUtils.split(StringUtils.substringBetween(column.getJdbcType(), "(", ")"), ",");
				if (ss != null && ss.length == 1 && Integer.parseInt(ss[0])<=6){
					column.setJavaType("Integer");
				}
				else{
					column.setJavaType("Long");
